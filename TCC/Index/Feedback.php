                ...
                <Div class="alterar_margen">    
                    <form name="formalterar" action="Feedback.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mensagem" id="menssagem" placeholder="Menssagem">
                        </div>
                       
                      
                        <button type="submit" value="Inserir" onclick="return validarForm()" class="btn btn-primary">Enviar</button>
                    </form>
                </Div>
            </div> 
        </div> 
