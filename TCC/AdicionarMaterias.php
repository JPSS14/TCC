        ...
        ?>
                <ul>
                    ...
                    <form action="AdicionarMaterias.php" method="post" class="form-inline" >
                            ...
                            <input style="margin-right: 1rem;" class="form-control" name="nomeMateria" type="text" placeholder="Nome Matéria">
                            <button type="submit" value="Cadastrar" class="btn btn-primary">Cadastrar Materia</button>
                    </form>
