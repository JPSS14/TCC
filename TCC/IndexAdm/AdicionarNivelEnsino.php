...
<html lang="pt-br">
  <head>
    ...
    <title>Adicionar Nivel de Ensino</title>
    </head>
    <body> 
        ...
        <div class="externa">
            ...
            ?>
                <ul>
                    ...
                    <form action="AdicionarNivelEnsino.php" method="post" class="form-inline" >
                       
                            <input style="margin-right: 1rem;" class="form-control" name="nomeNivel" type="text" placeholder="Nome Nivel">
